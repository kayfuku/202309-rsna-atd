...
def get_args():
    ...
    parser.add_argument('-d', '--debug', action='store_true', help="small dataset for debugging")
...
def main():
    ...
    logger = start_wandb(cfg) if cfg['general']['use_wandb'] else None

    # paths
    OUTPUT_PATH = cfg['general']['output_path']
    DATA_PATH = cfg['general']['input_path']
    TRAIN_IMG_PATHS = [
        f'{DATA_PATH}/rsna-abdominal-trauma-detection-png-pt1',
        f'{DATA_PATH}/rsna-abdominal-trauma-detection-png-pt2',
        f'{DATA_PATH}/rsna-2023-abdominal-trauma-detection-pngs-3-8',
        f'{DATA_PATH}/rsna-abdominal-trauma-detection-png-pt4',
        f'{DATA_PATH}/rsna-abdominal-trauma-detection-png-pt5',
        f'{DATA_PATH}/rsna-abdominal-trauma-detection-png-pt6',
        f'{DATA_PATH}/rsna-abdominal-trauma-detection-pngs-pt7',
        f'{DATA_PATH}/rsna-2023-abdominal-trauma-detection-pngs-18',
    ]
    TRAIN_DF_PATH = f'{DATA_PATH}/rsna-2023-abdominal-trauma-detection/train.csv'
    B_E_POS_PATH = f'{DATA_PATH}/b-e-data/b_e_pos.csv'
    B_E_NEG_PATH = f'{DATA_PATH}/b-e-data/sample_b_e_neg.csv'
    ...
    # train and validate
    print(f"Training {cfg['model']['model_type']}, {cfg['model']['model_name']}...")
    ...
    for fold_i in cfg['data']['fold_i']:
        ...
        torch.save(
            model,
            f"{OUTPUT_PATH}/{cfg['model']['model_name']}_{cfg['general']['exp_name']}_{cfg['model']['model_type']}_fold{fold_i}.pt")
        del model
        torch.cuda.empty_cache()
